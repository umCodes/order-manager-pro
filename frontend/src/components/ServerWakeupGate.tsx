...
/**
 * Gates the rest of the app behind one health check on load, shown as a card
 * centered over the page rather than a full-screen takeover. The backend
...
export default function ServerWakeupGate({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="modal-overlay">
      ...
      <div className="modal server-wakeup-card">
        {status === "checking" ? (
          <>
